...
draw_sprite_ext( indicator_efficiency, 0, x, y, 1, 1, 0, c_white, 1 );

if((global.known_efficiency<80)&&(global.known_efficiency>=60))
draw_sprite_ext( indicator_efficiency, 1, x, y, 1, 1, 0, c_white, 1 );

if((global.known_efficiency<60)&&(global.known_efficiency>=40))
draw_sprite_ext( indicator_efficiency, 2, x, y, 1, 1, 0, c_white, 1 );

if((global.known_efficiency<40)&&(global.known_efficiency>=20))
draw_sprite_ext( indicator_efficiency, 3, x, y, 1, 1, 0, c_white, 1 );

if((global.known_efficiency<20))
draw_sprite_ext( indicator_efficiency, 4, x, y, 1, 1, 0, c_white, 1 );
